...
@section('content')
    ...
    <form method="POST" action="{{route('grades.store')}}" class = "faq-form">
        ...
        <input
            ...
            id="quartile"
            name="quartile"
            value="{{$errors->any() ? old('quartile') : $grade->quartile}}"
        ><br>
        @error('quartile')
        ...
        <input
            ...
            id="course_name"
            name="course_name"
            value="{{$errors->any() ? old('course_name') :  $grade->course_name}}"
        ><br>
        @error('course_name')
        ...
        <input
            ...
            id="test_name"
            name="test_name"
            value="{{$errors->any() ? old('test_name') :  $grade->test_name}}"
        ><br>
        @error('test_name')
        ...
        <input
            ...
            id="EC"
            name="EC"
            value="{{$errors->any() ? old('EC') :  $grade->EC}}"
        ><br>
        @error('EC')
        ...
        <input
            ...
            value="{{$errors->any() ? old('lowest_passing_grade') :  $grade->lowest_passing_grade}}"
        ><br>
        ...
        <input
            ...
            id="best_grade"
            name="best_grade"
            value="{{$errors->any() ? old('best_grade') :  $grade->best_grade}}"
        ><br>
        @error('best_grade')
